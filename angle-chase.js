 ...
 line:{
  ...
  draw(k,b){
    return `<line x1="60" y1="150" x2="640" y2="150" stroke="${INK}" stroke-width="2"/>
      ...
      <text x="290" y="135" font-family="Atkinson Hyperlegible Mono" font-size="16" fill="${T}">${k}°</text>
      ...
      <text x="385" y="135" font-family="Atkinson Hyperlegible Mono" font-size="16" fill="${b!=null?T:A}">${b!=null?b+"°":"?"}</text>`;
  }
 },
 point:{
  ...
  draw(k,opp,adj,adj2){
    ...
    labels.forEach(([v,c,ang])=>{
      ...
      s+=`<text x="${lx}" y="${ly}" font-family="Atkinson Hyperlegible Mono" font-size="15" fill="${c}" text-anchor="middle">${v!=null?v+"°":"?"}</text>`;
    });
    return s;
  }
 },
 triangle:{
  ...
  draw(a,b,c){
    return `<polygon points="120,190 560,190 380,40" fill="none" stroke="${INK}" stroke-width="2"/>
      <text x="155" y="175" font-family="Atkinson Hyperlegible Mono" font-size="15" fill="${T}">${a}°</text>
      <text x="500" y="175" font-family="Atkinson Hyperlegible Mono" font-size="15" fill="${T}">${b}°</text>
      <text x="370" y="65" font-family="Atkinson Hyperlegible Mono" font-size="15" fill="${c!=null?T:A}">${c!=null?c+"°":"?"}</text>`;
  }
 },
 quad:{
  ...
  draw(a,b,c,d){
    return `<polygon points="120,190 520,150 460,40 160,60" fill="none" stroke="${INK}" stroke-width="2"/>
      ...
      <text x="145" y="175" font-family="Atkinson Hyperlegible Mono" font-size="14" fill="${T}">${a}°</text>
      <text x="475" y="140" font-family="Atkinson Hyperlegible Mono" font-size="14" fill="${T}">${b}°</text>
      <text x="430" y="55" font-family="Atkinson Hyperlegible Mono" font-size="14" fill="${T}">${c}°</text>
      <text x="175" y="70" font-family="Atkinson Hyperlegible Mono" font-size="14" fill="${d!=null?T:A}">${d!=null?d+"°":"?"}</text>`;
  }
 }
};
